export default {
  ...
  'app.header.menu.forOrganizations': 'For organizations',
  ...
  'app.header.menu.groups': 'Groups',
  'app.header.menu.organizations': 'Organizations',
