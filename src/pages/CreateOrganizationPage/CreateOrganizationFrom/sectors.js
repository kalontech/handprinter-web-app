export default [
    ...
    items: [
      {
        ...
        items: [{ name: 'Oil and gas extraction' }],
      },
      {
    ...
    items: [
      {
        ...
        items: [
          ...
          { name: 'Other nonresidential structures' },
          { name: 'Single-family residential structures' },
          { name: 'Multifamily residential structures' },
          { name: 'Other residential structures' },
        ],
      },
    ],
  },
    ...
    items: [
      ...
      },
      {
        ...
        items: [
          ...
          { name: 'Miscellaneous nonmetallic mineral products' },
        ],
      },
      {
        name: 'Primary metals',
      ...
      },
      {
        ...
        items: [
          { name: 'All other forging, stamping, and sintering' },
          { name: 'Custom roll forming' },
          { name: 'Crown and closure manufacturing and metal stamping' },
      ...
      },
      {
        ...
        items: [
          ...
          { name: 'Metal cutting and forming machine tool manufacturing' },
          { name: 'Special tool, die, jig, and fixture manufacturing' },
          {
            name:
      ...
      },
      {
        ...
        items: [
          ...
          { name: 'Automatic environmental control manufacturing' },
          { name: 'Industrial process variable instruments manufacturing' },
          { name: 'Totalizing fluid meter and counting device manufacturing' },
          { name: 'Electricity and signal testing instruments manufacturing' },
      ...
      },
      {
        ...
        items: [
          ...
          { name: 'Other household nonupholstered furniture' },
      ...
      },
      {
        ...
        items: [
          ...
          { name: 'Fluid milk and butter manufacturing' },
  ...
  },
  {
    ...
    items: [{ name: 'Wholesale trade', items: [{ name: 'Wholesale trade' }] }],
  },
  {
    name: 'Retail trade',
    items: [
      {
        ...
        items: [{ name: 'Motor vehicle and parts dealers' }],
      },
      {
        name: 'Food and beverage stores',
        items: [{ name: 'Food and beverage stores' }],
      },
      {
        name: 'General merchandise stores',
        items: [{ name: 'General merchandise stores' }],
      },
      { name: 'Other retail', items: [{ name: 'Other retail' }] },
    ],
  },
  {
    name: 'Transportation and warehousing',
    items: [
      { name: 'Air transportation', items: [{ name: 'Air transportation' }] },
      { name: 'Rail transportation', items: [{ name: 'Rail transportation' }] },
      {
        name: 'Water transportation',
        items: [{ name: 'Water transportation' }],
      },
      {
        name: 'Truck transportation',
        items: [{ name: 'Truck transportation' }],
      },
      {
        name: 'Transit and ground passenger transportation',
        items: [{ name: 'Transit and ground passenger transportation' }],
      },
      {
        name: 'Pipeline transportation',
        items: [{ name: 'Pipeline transportation' }],
      },
      {
      ...
      },
      {
        ...
        items: [{ name: 'Warehousing and storage' }],
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        items: [
          { name: 'Monetary authorities and depository credit intermediation' },
          {
            name: 'Nondepository credit intermediation and related activities',
          },
        ],
      },
      {
  ...
  },
  {
    ...
    items: [
      { name: 'Legal services', items: [{ name: 'Legal services' }] },
      {
      ...
      },
      {
        ...
        items: [
          ...
          { name: 'Environmental and other technical consulting services' },
      ...
      },
      {
        ...
        items: [{ name: 'Waste management and remediation services' }],
      },
    ],
  },
  {
    ...
    items: [
      ...
      { name: 'Hospitals', items: [{ name: 'Hospitals' }] },
      {
        ...
        items: [
          { name: 'Nursing and community care facilities' },
          {
            name:
    ...
    items: [
      {
        ...
        items: [
          ...
          { name: 'Museums, historical sites, zoos, and parks' },
        ],
      },
      {
        ...
        items: [
          ...
          { name: 'Gambling industries (except casino hotels)' },
          { name: 'Other amusement and recreation industries' },
        ],
      },
      { name: 'Accommodation', items: [{ name: 'Accommodation' }] },
      {
    ...
    items: [
      {
        ...
        items: [
          { name: 'Federal general government (defense)' },
          { name: 'Federal general government (nondefense)' },
        ],
      },
      {
      ...
      },
      {
        ...
        items: [{ name: 'State and local general government' }],
      },
      {
